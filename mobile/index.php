		...
		if ($_FILES["file"]["error"] > 0) {
			...
			if ($texto == "") {
				...
				if ($data) {
					...
					echo "Algo ocurrio... Intente otra vez más tarde";
				}
			}
		}else{
			$n = rand(0, 1000000);
...
<body>
	<div id="publish">
		<form method="POST" enctype="multipart/form-data">
			<br />
			<textarea placeholder="Escribe una nueva publicación" name="texto"></textarea>
	...
	?>
	<br />
	<div id="footer"><p>&copy; Grandpa Services</p></div><br />
</body>
</html>