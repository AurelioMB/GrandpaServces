<?php
	...
	if (isset($_POST["send"])) {
		...
		if ($msg=="") {
			echo "<h3>¡No puedes enviar un mensaje en blanco!</h3>";
		}else{
			...
			if ($data) {
				...
				echo "<h3>Algo salio mal al enviar tu mensaje ... Lo siento </h3>".mysql_error();
			}
		}
	}
?>
<html>
	...
	<body>
		<h2><a href="profile.php?id=<?php echo $id; ?>"><?php echo $saber["nome"]." (".$saber["apelido"].")"; ?></a></h2><br /><br /><br />
		<form method="POST">
			<div id="box">
			...
			<br />
			<div id="send">
				<a href="image.php?id=<?php echo $id; ?>"><input value="Imagen" type="button" name="image"></a>&nbsp;&nbsp;&nbsp;<input type="text" name="text" placeholder="Escribe aquí un mensaje ...." autocomplete="off">&nbsp;&nbsp;&nbsp;<input type="submit" name="send" value="Enviar">
			</div>
		</form>
	</body>
</html>