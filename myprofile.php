...
<body>
	<?php
		if ($saber["img"]=="") {
			echo '<a href="profilepic.php" style="width: 100px; display: block; margin: auto;"><img src="img/Anonimo.png" id="profile"></a>';
		}else{
	...
	<div id="menu">
		<form method="POST">
			<h2><?php echo $saber['nome']." (".$saber['apelido'].")<br>Edad: ".$saber['edad']." Años"; ?></h2><br />
