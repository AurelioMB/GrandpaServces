	...
	if (isset($_POST['save'])) {
		if ($_FILES["file"]["error"]>0) {
			...
			if ($data) {
				...
				echo "<script language='javascript' type='text/javascript'>alert('Se ha producido un error al actualizar tu foto ...');</script>";
			}
		}
	}
?>
<html>
	...
	<body>
		...
		<form method="POST" enctype="multipart/form-data" id="perfil">
			<br />
			<h3>Muestrale al mundo quien eres</h3><br />
			<h3>añadiendo una foto de perfil</h3><br /><br />
			<input type="file" name="file" /><br /><br /><br />
			<input type="submit" value="Cambiar" name="save" />
			<br /><br />
		</form>
		<br /><br /><br />
		<p>&copy; Grandpa Services, 2018</p>
	</body>
</html>